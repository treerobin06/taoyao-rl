...
SEED="${SEED:-1}"
RESULT_DIR="${RESULT_DIR:-results/o2o_p3_atlas_seed1_eval20_20260514}"
LOG_DIR="${LOG_DIR:-logs/o2o_p3_atlas_seed1_eval20_20260514}"
...
run_case "01_atlas_seed1_decay" \
  "RUN=atlas_o2o" \
  "ALGO_NAME=atlas_o2o_eval20_seed1_decay"

run_case "02_atlas_seed1_fixed" \
  "RUN=atlas_o2o_fixed" \
  "ALGO_NAME=atlas_o2o_eval20_seed1_fixed"
