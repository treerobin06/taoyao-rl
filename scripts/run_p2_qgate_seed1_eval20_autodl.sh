...
SEED="${SEED:-1}"
RESULT_DIR="${RESULT_DIR:-results/o2o_p2_qgate_seed1_eval20_20260514}"
LOG_DIR="${LOG_DIR:-logs/o2o_p2_qgate_seed1_eval20_20260514}"
ATLAS_LABEL="${ATLAS_LABEL:-results/atlas_labels/atlas_selector_hopper-medium-replay-v2_seed1.npz}"
...
run_case "01_td3_bc_seed1_decay" \
  "RUN=td3_bc_o2o" \
  "ALGO_NAME=td3_bc_o2o_eval20_seed1_decay"

run_case "02_atlas_seed1_qgate_fixed" \
  "RUN=atlas_o2o_fixed" \
  "ALGO_NAME=atlas_o2o_eval20_seed1_qgate_fixed" \
